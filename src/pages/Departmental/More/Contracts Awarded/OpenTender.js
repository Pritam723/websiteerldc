...
export default function OpenTender() {
  ...
  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "OpenTender";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Open Tender";
  ...
  const breadcrumb = [
    ...
    { label: "Open Tender", route: "/more/contractsawarded/opentender" },
  ];

  const redirectionURL = "more/contractsawarded/opentender";
