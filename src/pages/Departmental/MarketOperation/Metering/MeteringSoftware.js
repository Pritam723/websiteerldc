...
export default function MeteringSoftware() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "MeteringSoftware";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Metering Software";

  const breadcrumb = [
    { label: "Market Operation" },

    {
      label: "Metering Software",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/marketoperation/metering/meteringsoftware";
