...
export default function MeteringManual() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "MeteringManual";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Metering Manual";

  const breadcrumb = [
    { label: "Market Operation" },

    {
      label: "Metering Manual",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/marketoperation/metering/meteringmanual";
