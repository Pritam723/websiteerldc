...
export default function TimeCorrectionManual() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "TimeCorrectionManual";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Time Correction Manual";

  const breadcrumb = [
    { label: "Market Operation" },

    {
      label: "Time Correction Manual",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/marketoperation/metering/timecorrectionmanual";
