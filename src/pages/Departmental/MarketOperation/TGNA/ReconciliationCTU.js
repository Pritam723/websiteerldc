...
export default function ReconciliationCTU() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "ReconciliationCTU";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Reconciliation CTU";
  ...
  const breadcrumb = [
    ...
    {
      label: "Reconciliation CTU",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/marketoperation/tgna/reconciliationctu";
