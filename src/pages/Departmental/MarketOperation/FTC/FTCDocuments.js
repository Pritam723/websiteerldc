...
export default function FTCDocuments() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "FTCDocuments";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "First Time Charging Documents";

  const breadcrumb = [

    { label: "FTC" },
    {
      label: "First Time Charging Documents",
    },
  ];

  const redirectionURL = "/marketoperation/ftc/ftcdocuments";
