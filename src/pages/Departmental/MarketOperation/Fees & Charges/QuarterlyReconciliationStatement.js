...
export default function QuarterlyReconciliationStatement() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "QuarterlyReconciliationStatement";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Quarterly Reconciliation Statement";

  const breadcrumb = [
    { label: "Market Operation" },

    {
      label: "Quarterly Reconciliation Statement",
    },
