...
export default function SupplementaryAndPLIBill() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "SupplementaryAndPLIBill";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Supplementary & PLI Bill";

  const breadcrumb = [
    { label: "Market Operation" },

    {
      label: "Supplementary & PLI Bill",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL =
    "/marketoperation/feesandcharges/supplementaryandplibill";
