...
export default function CongestionReport() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "CongestionReport";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Congestion Report";
  ...
  const breadcrumb = [
    ...
    {
      label: "CongestionReport",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/marketoperation/reports/congestionreport";
