...
export default function DSMReconcilation() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "DSMReconcilation";
  // Must be same as it is in Flask -> ORM Class(Model) -> _tablename_
  const pageTitle = "DSM Reconcilation";
  ...
  const breadcrumb = [
    ...
    {
      label: "DSM Reconcilation",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/marketoperation/dsm/dsmreconcilation";
