...
export default function YearAheadForecastingError() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "YearAheadForecastingError";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Year Ahead Forecasting Error";
  ...
  const breadcrumb = [
    ...
    {
      label: "Year Ahead Forecasting Error",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL =
    "/systemoperation/forecasting/yearaheadforecastingerror";
