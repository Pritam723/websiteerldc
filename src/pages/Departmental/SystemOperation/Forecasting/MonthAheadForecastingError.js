...
export default function MonthAheadForecastingError() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "MonthAheadForecastingError";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Month Ahead Forecasting Error";
  ...
  const breadcrumb = [
    ...
    {
      label: "Month Ahead Forecasting Error",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL =
    "/systemoperation/forecasting/monthaheadforecastingerror";
