...
export default function WeekAheadRollingForecast() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "WeekAheadRollingForecast";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Week Ahead Rolling Forecast";
  ...
  const breadcrumb = [
    ...
    {
      label: "Week Ahead Rolling Forecast",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL =
    "/systemoperation/forecasting/weekaheadrollingforecast";
