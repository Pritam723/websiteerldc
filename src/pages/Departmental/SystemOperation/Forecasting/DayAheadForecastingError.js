...
export default function DayAheadForecastingError() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "DayAheadForecastingError";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Day Ahead Forecasting Error";
  ...
  const breadcrumb = [
    ...
    {
      label: "Day Ahead Forecasting Error",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL =
    "/systemoperation/forecasting/dayaheadforecastingerror";
