...
export default function WeekAheadForecastingError() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "WeekAheadForecastingError";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Week Ahead Forecasting Error";
  ...
  const breadcrumb = [
    ...
    {
      label: "Week Ahead Forecasting Error",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL =
    "/systemoperation/forecasting/weekaheadforecastingerror";
