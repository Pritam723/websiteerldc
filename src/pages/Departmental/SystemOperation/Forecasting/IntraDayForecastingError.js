...
export default function IntraDayForecastingError() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "IntraDayForecastingError";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Intra Day Forecasting Error";
  ...
  const breadcrumb = [
    ...
    {
      label: "Intra Day Forecasting Error",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL =
    "/systemoperation/forecasting/intradayforecastingerror";
