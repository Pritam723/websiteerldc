...
export default function DailyPSPReport() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "DailyPSPReport";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Daily PSP Report";
  ...
  const breadcrumb = [
    ...
    { label: "MIS Reports" },
    {
      label: "Daily PSP Report",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/reports/dailyreport/misreports/dailypspreport";
