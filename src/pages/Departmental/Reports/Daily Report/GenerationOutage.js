...
export default function GenerationOutage() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "GenerationOutage";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Generation Outage";
  ...
  const breadcrumb = [
    ...
    { label: "MIS Reports" },
    {
      label: "Generation Outage",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/reports/dailyreport/misreports/generationoutage";
