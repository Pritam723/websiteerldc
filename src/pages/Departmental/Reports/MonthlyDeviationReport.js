...
export default function MonthlyDeviationReport() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "MonthlyDeviationReport";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Monthly Deviation Report";
  ...
  const breadcrumb = [
    ...
    { label: "MIS Reports" },
    {
      label: "Monthly Deviation Report",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/reports/monthlydeviationreport";
