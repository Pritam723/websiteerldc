...
export default function VDIDaily() {
  /////////////////// Page Meta Data ////////////////////////////////////////

  ///////////////// Static Meta Data ///////////////////////////////////////
  const targetTableClass = "VDIDaily";
  // Must be same as it is in Flask -> ORM Class(Model) -> __tablename__
  const pageTitle = "Voltage Deviation Index – Daily";
  ...
  const breadcrumb = [
    ...
    { label: "MIS Reports" },
    {
      label: "Voltage Deviation Index – Daily",
    },
    // { label: "User Profile", route: "/user/userprofile" },
  ];

  const redirectionURL = "/reports/voltagedeviationindex/daily";
